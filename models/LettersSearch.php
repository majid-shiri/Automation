...
class LettersSearch extends Letters
{
    ...
    {
        return [
            [['let_Id', 'let_Date', 'let_Type', 'let_ActionType', 'let_SecurityType', 'let_State', 'let_Referral', 'let_ReplayType', 'let_FollowUpType', 'let_AttachType', 'let_CopiesType', 'let_ParaffType', 'let_ArchiveType', 'let_ResDateType', 'let_ResDate', 'let_Create_at','let_Edit_at', 'let_us_FK'], 'integer'],
            [['let_Subject', 'let_Abstract', 'let_Text', 'let_Recipient', 'let_Sender', 'let_NumberIn', 'let_NumberSys'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        if($us_id)
        {
            $query = Letters::find()->where(['let_us_FK'=>$us_id])->andWhere(['let_State'=>0])->andWhere(['let_refconf'=>0])->andWhere(['!=', 'let_refconf_state', 2]);
